  ...
  render() {
    return (
      <div className="p-style-guide-progress-bars">
        ...
        <h2>Styles</h2>
        <ProgressBar styleType="success" value={25} />
        <ProgressBar styleType="info" value={50} />
        <ProgressBar styleType="warning" value={75} />
        <ProgressBar styleType="danger" value={100} />
        <h2>Striped</h2>
        <ProgressBar styleType="success" isStriped={true} value={25} />
        <ProgressBar styleType="info" isStriped={true} value={50} />
        <ProgressBar styleType="warning" isStriped={true} value={75} />
        <ProgressBar styleType="danger" isStriped={true} value={100} />
      </div>
    );
  }
}
