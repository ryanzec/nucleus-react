...
extendText.getDefaultProps = function() {
  return {
    onChange: null,
    defaultValue: null,
...
extendText.getInitialState = function() {
...
extendText.componentDidMount = function() {
...
extendText.componentDidUpdate = function() {
  this.setAutoCompletePosition();
};

extendText.getCssClasses = function() {
...
extendText.getInputElement = function() {
  return this.refs.input.refs.input.getDOMNode();
};

extendText.isAutoCompleteDisplayValue = function(displayValue) {
...
extendText.getAutoCompleteIndex = function(displayValue) {
  var index = null;
...
extendText.updateDisplayValue = function(newValue) {
  var newDisplayValue;
...
extendText.updateValue = function(newValue, updateDisplayValue) {
  var updatedState = {};
...
extendText.removeValue = function(valueIndex) {
...
extendText.onChange = function(event) {
...
extendText.setAutoCompletePosition = function() {
...
extendText.isOverCharacterThreshold = function() {
  if(!this.isMounted()) {
    return false;
  }
...
extendText.selectCurrentValue = function() {
...
extendText.onBlur = function() {
  this.selectCurrentValue();
};

extendText.increaseFocusedAutoCompleteItem = function() {
...
extendText.decreaseFocusedAutoCompleteItem = function() {
  if(this.state.autoCompleteItems.length > 0) {
    var newFocusedAutoCompleteItem = this.state.focusedAutoCompleteItem;
...
extendText.onKeyDown = function(event) {
  switch(event.which) {
    case 27: //escape
...
extendText.renderAutoComplete = function() {
  var autoCompleteDom;
