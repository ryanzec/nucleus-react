...
describe('radio input component', function() {
  ...
  it('should run and be able to show validation on initial load', function() {
    this.component = React.render(<RadioInput name={radioName} options={getOptions()} renderValidation="both" renderValidationOnLoad={true} validate={validateFalse} />, div);
    var formElement = reactTestUtils.findRenderedDOMComponentWithClass(this.component, 'form-element');
    var validationIcon = this.component.getDOMNode().querySelectorAll('.form-element__validation-icon');
  ...
  it('should not show valid validation if configued for invalid only', function() {
    this.component = React.render(<RadioInput name={radioName} options={getOptions()} renderValidation="invalid" validate={validateTrue} />, div);
    var input = reactTestUtils.scryRenderedDOMComponentsWithTag(this.component, 'input');
  ...
  it('should show invalid validation', function() {
    this.component = React.render(<RadioInput name={radioName} options={getOptions()} renderValidation="both" validate={validateFalse} />, div);
    var input = reactTestUtils.scryRenderedDOMComponentsWithTag(this.component, 'input');
  ...
  it('should not show invalid validation if configured for valid only', function() {
    this.component = React.render(<RadioInput name={radioName} options={getOptions()} renderValidation="valid" validate={validateFalse} />, div);
    var input = reactTestUtils.scryRenderedDOMComponentsWithTag(this.component, 'input');
