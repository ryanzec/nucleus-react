...
var PopoverHandle = function (_React$Component) {
  _inherits(PopoverHandle, _React$Component);

  function PopoverHandle(props) {
    _classCallCheck(this, PopoverHandle);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(PopoverHandle).call(this, props));
  }

  _createClass(PopoverHandle, [{
    ...
    value: function getCssClasses() {
      var cssClasses = ['popover__handle'];
