...
var DropDownMenuDivider = function (_React$Component) {
  _inherits(DropDownMenuDivider, _React$Component);

  function DropDownMenuDivider(props) {
    _classCallCheck(this, DropDownMenuDivider);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(DropDownMenuDivider).call(this, props));
  }

  _createClass(DropDownMenuDivider, [{
    ...
    value: function getCssClasses() {
      var cssClasses = ['drop-down-menu__divider'];
