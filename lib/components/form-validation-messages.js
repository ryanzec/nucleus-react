...
var FormValidationMessages = function (_React$Component) {
  _inherits(FormValidationMessages, _React$Component);

  function FormValidationMessages(props) {
    _classCallCheck(this, FormValidationMessages);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FormValidationMessages).call(this, props));
  }

  _createClass(FormValidationMessages, [{
...
FormValidationMessages.defaultProps = {
  className: null
};
