...
var FormTextbox = function (_React$Component) {
  _inherits(FormTextbox, _React$Component);

  function FormTextbox(props) {
    _classCallCheck(this, FormTextbox);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FormTextbox).call(this, props));
  }
  ...
  _createClass(FormTextbox, [{
    ...
    value: function getCssClasses() {
      var cssClasses = [this.props.type === 'textarea' || this.props.type === 'file' ? 'form-element__' + this.props.type : 'form-element__textbox'];
    ...
    value: function render() {
      if (this.props.type === 'textarea') {
        ...
        }, (0, _getPassThroughProperties2.default)(this.props, 'className', 'type')));
      }
