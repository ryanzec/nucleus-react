...
var FormSelectOption = function (_React$Component) {
  _inherits(FormSelectOption, _React$Component);

  function FormSelectOption(props) {
    _classCallCheck(this, FormSelectOption);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FormSelectOption).call(this, props));
  }

  _createClass(FormSelectOption, [{
    ...
    value: function getCssClasses() {
      var cssClasses = ['form-element__select-option'];
