...
var FormTextboxGroup = function (_React$Component) {
  _inherits(FormTextboxGroup, _React$Component);

  function FormTextboxGroup(props) {
    _classCallCheck(this, FormTextboxGroup);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(FormTextboxGroup).call(this, props));
  }

  _createClass(FormTextboxGroup, [{
    ...
    value: function getCssClasses() {
      var cssClasses = ['form-element__textbox-group'];
...
exports.default = FormTextboxGroup;